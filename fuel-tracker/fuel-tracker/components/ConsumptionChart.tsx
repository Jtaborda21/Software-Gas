  ...
  return (
    <div className="panel p-4 sm:p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-display text-base font-semibold text-dash-text">{t("chart.title")}</h3>
      </div>
          ...
          <ComposedChart data={data} margin={{ top: 4, right: 8, left: -16, bottom: 0 }}>
            ...
            <Tooltip
              formatter={(value: number, name: string) =>
                name === t("chart.spent") ? [formatCOP(value), name] : [value, name]
              }
              contentStyle={{
                background: "#1B2129",
            ...
            <Line
              ...
              name={t("chart.efficiency", { unit: effUnit })}
              stroke="#22C7A9"
              strokeWidth={2.5}
              dot={{ r: 3, fill: "#22C7A9" }}
              connectNulls
